...
public class GameSelectionDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        final AlertDialog dialog = builder.setItems(R.array.new_game_selection, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                mListener.onDialogGameSelection(GameSelectionDialog.this, which);
            }
        }).create();
        return dialog;
    }
